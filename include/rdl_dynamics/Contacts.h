...
namespace RobotDynamics
{
     ...
     */
    struct RDL_DLLAPI ConstraintSet
    {
     ...
     */
    RDL_DLLAPI void calcContactJacobian(Model               & model,
                                        const Math::VectorNd& Q,
                                        const ConstraintSet & CS,
                                        Math::MatrixNd      & G,
                                        bool                  update_kinematics = true);

    RDL_DLLAPI void calcContactSystemVariables(Model               & model,
                                               const Math::VectorNd& Q,
     ...
     *
     */
    RDL_DLLAPI void forwardDynamicsContactsDirect(Model               & model,
                                                  const Math::VectorNd& Q,
                                                  const Math::VectorNd& QDot,
                                                  const Math::VectorNd& Tau,
                                                  ConstraintSet       & CS,
    ...
    RDL_DLLAPI void forwardDynamicsContactsRangeSpaceSparse(Model               & model,
                                                            const Math::VectorNd& Q,
                                                            const Math::VectorNd& QDot,
                                                            const Math::VectorNd& Tau,
                                                            ConstraintSet       & CS,
    ...
    RDL_DLLAPI void forwardDynamicsContactsNullSpace(Model               & model,
                                                     const Math::VectorNd& Q,
                                                     const Math::VectorNd& QDot,
                                                     const Math::VectorNd& Tau,
                                                     ConstraintSet       & CS,
     ...
     */
    RDL_DLLAPI void forwardDynamicsContactsKokkevis(Model               & model,
                                                    const Math::VectorNd& Q,
                                                    const Math::VectorNd& QDot,
                                                    const Math::VectorNd& Tau,
                                                    ConstraintSet       & CS,
     ...
     */
    RDL_DLLAPI void computeContactImpulsesDirect(Model               & model,
                                                 const Math::VectorNd& Q,
     ...
     */
    RDL_DLLAPI void computeContactImpulsesRangeSpaceSparse(Model               & model,
                                                           const Math::VectorNd& Q,
                                                           const Math::VectorNd& QDotMinus,
                                                           ConstraintSet       & CS,
                                                           Math::VectorNd      & QDotPlus);
     ...
     */
    RDL_DLLAPI void computeContactImpulsesNullSpace(Model               & model,
                                                    const Math::VectorNd& Q,
                                                    const Math::VectorNd& QDotMinus,
                                                    ConstraintSet       & CS,
                                                    Math::VectorNd      & QDotPlus);
     ...
     */
    RDL_DLLAPI void solveContactSystemDirect(Math::MatrixNd      & H,
     ...
     */
    RDL_DLLAPI void solveContactSystemRangeSpaceSparse(Model               & model,
                                                       Math::MatrixNd      & H,
                                                       const Math::MatrixNd& G,
                                                       const Math::VectorNd& c,
                                                       const Math::VectorNd& gamma,
     ...
     */
    RDL_DLLAPI void solveContactSystemNullSpace(Math::MatrixNd      & H,
                                                const Math::MatrixNd& G,
                                                const Math::VectorNd& c,
                                                const Math::VectorNd& gamma,
                                                Math::VectorNd      & qddot,
